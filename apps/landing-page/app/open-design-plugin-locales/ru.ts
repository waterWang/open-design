...
const ru: OpenDesignPluginCopy = {
  ...
  demo: {
    ...
    installBody:
      'Вставьте эту инструкцию в задачу Codex. Codex прочитает раздел установки в репозитории и настроит плагин вместе с локальным MCP — публикация в открытом каталоге плагинов для этого не нужна.',
